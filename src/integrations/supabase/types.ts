...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      report_reason: "spam" | "unsafe" | "wrong_board" | "not_neighborly" | "other";
      report_status: "open" | "dismissed" | "actioned";
      report_target: "post" | "place" | "profile" | "thread" | "store_listing";
      store_listing_status: "draft" | "available" | "reserved" | "sold" | "archived";
      store_order_status: "pending" | "paid" | "cancelled" | "refunded" | "fulfilled";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
